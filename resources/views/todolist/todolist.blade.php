...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row">
        {{-- ini aksi nya mengarah ke route  Route::post('/logout','doLogout')->middleware([OnlyMemberMiddleware::class]);--}}
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://www.programmerzamannow.com/">Arif Rizal
                    </a></p>
        </div>
